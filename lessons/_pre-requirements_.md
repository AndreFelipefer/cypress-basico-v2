...
- [Node.js](https://nodejs.org/en/) (estou usando a versão `v21.5.0` enquanto escrevo esta aula)
...
- [Visual Studio Code](https://code.visualstudio.com/) (estou usando a versão `1.85.1` enquanto escrevo esta aula) ou alguma outra IDE de sua preferência
